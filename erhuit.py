...
class Blockchain(object):
	...
	def hash(block):
		...
		#We must make sure thtat the Dictionary is Ordered, or we'll have inconsistent hashes
	...
	def mine():
		...
		#Forget the new Block b adding it to the chain
	...
	def resolve_conflicts(self):
		"""
		Resolves conflicts by replacing the chain with the longest
		one in the network.
